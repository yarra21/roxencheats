      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          >
            ...
            <span className="text-purple-500 neon-text-purple">ÖZELLİKLER</span>
          </motion.h2>
          <motion.p
            initial={{ opacity: 0 }}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-gray-900/50 backdrop-blur-sm p-6 rounded-lg border border-gray-800 hover:border-purple-500/50 transition-all duration-300 hover-scale"
            >
              <div
